...
docker run -it --name build-opencv -v $PWD/opencv:/var/build/opencv -v $PWD/opencv_contrib:/var/build/opencv_contrib -v $PWD/makefile:/var/build/makefile nvidia/cuda:11.8.0-devel-ubuntu18.04 /bin/bash -c "cd /var/build; \
	apt-get update; \
